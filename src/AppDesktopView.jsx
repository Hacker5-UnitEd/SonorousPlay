...
const AppDesktopView = ({ node, hash, albumList, tempPlaylist, playlist, setPlaylist, activeSongIndex, setActiveSongIndex, isPlaying, setIsPlaying, searchQuery, setSearchQuery, isLoading, setIsLoading, ownFeed, enabled, setEnabled }) => {
    return (
        <div className={ `static grid h-screen w-screen place-items-center bg-black text-center px-20 py-5 bg-[url("src/assets/darkBackground.png")]` }>
